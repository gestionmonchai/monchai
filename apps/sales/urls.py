...
urlpatterns = [
    ...
    path('tarifs/<int:pk>/', views_pricelists.pricelist_detail, name='pricelist_detail'),
    path('tarifs/<int:pk>/modifier/', views_pricelists.pricelist_edit, name='pricelist_edit'),
    path('tarifs/<int:pk>/supprimer/', views_pricelists.pricelist_delete, name='pricelist_delete'),
    
    # Édition en grille
    path('tarifs/<int:pk>/grille/', views_pricelists.pricelist_grid_edit, name='pricelist_grid_edit'),
