...
from .views_inventory import InventoryRedirectView
...
urlpatterns = [
    ...
    path('vendanges/<uuid:pk>/', prod_views.VendangeDetailView.as_view(), name='vendange_detail'),
    path('vendanges/<uuid:pk>/modifier/', prod_views.VendangeUpdateView.as_view(), name='vendange_update'),
    path('vendanges/<uuid:pk>/affecter-cuvee/', prod_views.VendangeAffecterCuveeView.as_view(), name='vendange_affecter_cuvee'),
    path('vendanges/<uuid:pk>/encuvage/', prod_views.EncuvageWizardView.as_view(), name='vendange_encuvage'),
    ...
    path('lots-techniques/<uuid:pk>/', prod_views.LotTechniqueDetailView.as_view(), name='lot_tech_detail'),
    path('lots-techniques/<uuid:pk>/mouvements/export/', prod_views.lot_mouvements_export, name='lot_mouvements_export'),
    ...
    path('lots-elevage/analyses/', prod_views.AnalysesHomeView.as_view(), name='lots_elevage_analyses'),
    path('lots-elevage/analyses/table/', prod_views.AnalysesTableView.as_view(), name='lots_elevage_analyses_table'),
    ...
    path('contenants/<uuid:pk>/', cont_views.ContenantDetailView.as_view(), name='contenants_detail'),
    path('contenants/<uuid:pk>/edit/', cont_views.ContenantUpdateView.as_view(), name='contenants_edit'),
    # Actions Contenant
    path('contenants/<uuid:pk>/occupancy/recalc/', cont_views.contenant_recalc_occupancy, name='contenants_recalc'),
    path('contenants/<uuid:pk>/actions/affecter-lot/', cont_views.ContenantAffecterLotView.as_view(), name='contenants_affecter_lot'),
    path('contenants/<uuid:pk>/actions/vidange/', cont_views.ContenantVidangeView.as_view(), name='contenants_vidange'),
    path('contenants/<uuid:pk>/actions/nettoyage/', cont_views.ContenantNettoyageView.as_view(), name='contenants_nettoyage'),
    ...
    path('assemblages/<uuid:pk>/', AssemblageDetailView.as_view(), name='assemblage_detail'),
    ...
    path('lots-techniques/<uuid:pk>/action/<str:action>/', prod_views.LotTechniqueActionView.as_view(), name='lot_tech_action'),

    # Affectation cuvée sur lot technique
    path('lots-techniques/<uuid:pk>/affecter-cuvee/', prod_views.LotTechAffecterCuveeView.as_view(), name='lot_tech_affecter_cuvee'),
    
    # Wizards & opérations
    path('lots-techniques/<uuid:pk>/soutirage/', prod_views.SoutirageWizardView.as_view(), name='lot_tech_soutirage'),
    path('lots-techniques/<uuid:pk>/pressurage/', prod_views.PressurageWizardView.as_view(), name='lot_tech_pressurage'),
    path('lots-techniques/<uuid:pk>/vinif/measure/add/', prod_views.lot_vinif_add_measure, name='lot_vinif_add_measure'),
    path('lots-techniques/<uuid:pk>/vinif/intervention/add/', prod_views.lot_vinif_add_intervention, name='lot_vinif_add_intervention'),
